 ...
 *slime-scratch*
 ...
 Enable Paredit and Company in Lisp related minibuffers
  - Function [[file:init.el#L2124][k-slime-command-p]], [[file:init.el#L2132][sexp-minibuffer-hook]]

 Slime debug window non-prolifiration
** Package [[file:init.el#L2143][slime-repl]]
...
** Package [[file:init.el#L2240][smerge-mode]]
...
** Package [[file:init.el#L2923][org]]
  - Function [[file:init.el#L2930][check-latex-fragment]], [[file:init.el#L2962][k-org-mode-hook]]
  - Package [[file:init.el#L2970][org-contrib]], [[file:init.el#L2975][org-variable-pitch]], [[file:init.el#L2977][org-superstar]], [[file:init.el#L2989][poly-org]]
  - Function [[file:init.el#L3008][k-polymode-init-inner-hook]]
  - Package [[file:init.el#L3013][engrave-faces]]

* [[file:init.el#L3055][ERC]]

** Package [[file:init.el#L3057][erc]]
  - Function [[file:init.el#L3078][erc-insert-timestamp-right]]

* [[file:init.el#L3092][Email]]
  - Function [[file:init.el#L3109][insert-plist]], [[file:init.el#L3140][k-format-relative-date]]
  - Package [[file:init.el#L3157][message]]

** Package [[file:init.el#L3164][notmuch]]

 Custom email entry formatting
  - Function [[file:init.el#L3190][notmuch-search-show-result]]: Insert RESULT at POS.
  - Function [[file:init.el#L3224][k-ensure-davmail]]: Make sure davmail is running.
  - Function [[file:init.el#L3236][k-update-notmuch-unread-count]]
  - Function [[file:init.el#L3238][k-update-notmuch]]: Update email database asynchronously.
  - Function [[file:init.el#L3259][k-notmuch-unread-status]]
  - Package [[file:init.el#L3266][smtpmail]]

* [[file:init.el#L3276][Input Method]]

** Package [[file:init.el#L3278][pyim]]
  - Function [[file:init.el#L3283][k-pyim-probe]]
  - Package [[file:init.el#L3292][pyim-basedict]], [[file:init.el#L3294][pyim-greatdict]]

* [[file:init.el#L3299][⭐ Misc handy commands]]
  - Function [[file:init.el#L3303][lookup-word]]
  - Function [[file:init.el#L3311][demolish-package]]: Nuke everything under namespace SYMBOL.
 ...
 https://gist.github.com/jdtsmith/1fbcacfe677d74bbe510aec80ac0050c
  - Function [[file:init.el#L3329][k-reraise-error]]: Call function FUNC with ARGS and re-raise any error which occurs.
    Useful for debugging post-command hooks and filter functions, which
    normally have their errors suppressed.
  - Function [[file:init.el#L3337][toggle-debug-on-hidden-errors]]: Toggle hidden error debugging for function FUNC.
  - Function [[file:init.el#L3348][k-straight-freeze-versions]]: Run `straight-freeze-versions' asynchronously in Emacs subprocess.

* [[file:init.el#L3358][⭐ Status area]]
 ...
 A status area at the right bottom corner (using the right side of global echo area).  It is used for displaying battery, time, and vampire time zone.
  - Function [[file:init.el#L3366][k-time-status]]: Status function for current time.
  - Function [[file:init.el#L3370][k-battery-status]]: Status function for battery status.
  - Function [[file:init.el#L3393][k-telega-status]]
  - Function [[file:init.el#L3403][k-status-update]]: Update status area.
