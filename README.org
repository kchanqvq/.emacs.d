...
* [[file:init.el#L37][Util functions]]
  ...
  - Function [[file:init.el#L54][k-guix-p]]
  - Macro [[file:init.el#L57][k-use-guix-maybe]]
  - Function [[file:init.el#L63][delete-from-list]]
  - Macro [[file:init.el#L66][with-advice]]: Temporarily add ADVICE to SYMBOL during evaluation of BODY.
  - Function [[file:init.el#L76][k-run-helper-command]]: Run helper shell COMMAND in buffer with NAME.
    Run CONTINUATION once the shell process exited.
    If SILENT is non-nil, do not display the NAME buffer.
  - Function [[file:init.el#L94][k-global-set-key]]: Bind KEY to COMMAND, also works in EXWM windows.
  - Function [[file:init.el#L100][k-fill-right]]: Prepend a variable space to STRING to make it right-aligned.
  - Function [[file:init.el#L111][k-insert-fill-right]]: Insert STRING and make it right-aligned using a variable space.
  ...
  - Function [[file:init.el#L126][k-truncate-string-to-width]]: Truncate STRING to PIXEL-WIDTH.
    Use binary search.
  - Function [[file:init.el#L141][k-ensure-prefix-map]]

* [[file:init.el#L144][Misc config]]
  - Package [[file:init.el#L175][vlf]]

* [[file:init.el#L182][⭐ Mode line]]
  - Function [[file:init.el#L188][k-pad-mode-line-format]]: Format the mode line as a string according to FORMAT and RIGHT-FORMAT.
  ...
  - Function [[file:init.el#L247][k-pad-header-line-after-advice]]: Add padding to header line using `k-pad-mode-line-format'.
    ...
    repeated invocation.
  - Function [[file:init.el#L269][k-compute-tab-line]]: Add an empty tab line to windows in FRAME to simulate bottom dividers.
  ...
  - Package [[file:init.el#L281][package]]

* [[file:init.el#L283][In buffer completion (company)]]

** Package [[file:init.el#L525][company]]
 ...
 ⭐ Don't let `company-elisp' quickhelp hijack `*Help*' buffer
  - Advice [[file:init.el#L516][company-capf]], [[file:init.el#L521][help-buffer]]
...
* [[file:init.el#L542][Generic stripes]]
 I prefer using text-property to color stuff, but when I don't feel like trying I use `stripes' overlays.
  - Package [[file:init.el#L548][stripes]]

** Package [[file:init.el#L559][hl-line]]
...
** [[file:init.el#L599][Color palette]]
  ...
  - Function [[file:init.el#L630][k-generate-theme]]: Algorithmically generate and load theme.
...
* [[file:init.el#L1293][⭐ Message to per window echo area]]
  - Function [[file:init.el#L1301][k-message]]: Like `message' but in k-echo-area.
...
* [[file:init.el#L1337][Time]]
  - Package [[file:init.el#L1341][time]]

* [[file:init.el#L1344][Appearances]]
  - Package [[file:init.el#L1347][all-the-icons]], [[file:init.el#L1356][volatile-highlights]], [[file:init.el#L1359][highlight-indent-guides]], [[file:init.el#L1366][highlight-parentheses]], [[file:init.el#L1374][topsy]], [[file:init.el#L1382][outline]]

* [[file:init.el#L1387][Indent and whitespace]]
  - Package [[file:init.el#L1391][clean-aindent-mode]], [[file:init.el#L1394][dtrt-indent]], [[file:init.el#L1399][ws-butler]], [[file:init.el#L1403][snap-indent]]

* [[file:init.el#L1407][General Programming Utilities]]

** Package [[file:init.el#L1422][flycheck]]
  - Function [[file:init.el#L1415][k-flycheck-display-error-messages]]
  - Package [[file:init.el#L1425][lsp-mode]]

* [[file:init.el#L1431][TeX]]
  - Package [[file:init.el#L1435][lsp-ltex]]
...
** Package [[file:init.el#L1468][tex]]
 ...
 to have the buffer refresh after compilation
  ...
  - Package [[file:init.el#L1472][cdlatex]]

* [[file:init.el#L1474][⭐ Completion system]]

** Package [[file:init.el#L1600][vertico]]
 ...
 Patch `read-from-kill-ring' so that it doesn't collapse entries to single line
  - Function [[file:init.el#L1495][read-from-kill-ring]]: Read a `kill-ring' entry using completion and minibuffer history.
    PROMPT is a string to prompt with.

 Patch `vertico--truncate-multiline'
  - Function [[file:init.el#L1545][vertico--truncate-multiline]]: Truncate multiline CAND.
...
** Package [[file:init.el#L1683][vertico-buffer]]
...
** Package [[file:init.el#L1725][orderless]]
  - Package [[file:init.el#L1729][consult]]
...
** Package [[file:init.el#L1786][exwm]]
...
** Package [[file:init.el#L1885][macrostep]]
...
** Package [[file:init.el#L1936][comment-or-uncomment-sexp]]
 #+nil structural comment for Common Lisp
  - Macro [[file:init.el#L1895][advance-save-excursion]], [[file:init.el#L1901][structured-comment-maybe]]
  - Function [[file:init.el#L1921][structured-comment-advice]]
  - Function [[file:init.el#L1926][structured-comment-defun]]: Use #+nil to comment a top-level form for Common Lisp.
  - Package [[file:init.el#L1939][paredit]]

** Package [[file:init.el#L1964][paxedit]]
  - Function [[file:init.el#L1956][paxedit-copy-1]], [[file:init.el#L1961][paxedit-kill-1]]
  - Package [[file:init.el#L1968][rainbow-mode]]
  - Advice [[file:init.el#L1977][eval-last-sexp]]

** Package [[file:init.el#L2069][slime]]
  - Advice [[file:init.el#L1998][slime-load-contribs]], [[file:init.el#L2000][slime-eval-last-expression]]

 Handy slime commands and key bindings
  - Function [[file:init.el#L2012][ensure-slime]]
  - Function [[file:init.el#L2018][slime-undefine]]: Undefine toplevel definition at point.

 *slime-scratch*
  - Function [[file:init.el#L2037][switch-to-scratch]]: Switch to scratch buffer.

 Slime mode line
  - Function [[file:init.el#L2046][slime-mode-line]]

 Hacks to make slime-autodoc works better

 Enable Paredit and Company in Lisp related minibuffers
  - Function [[file:init.el#L2056][k-slime-command-p]], [[file:init.el#L2061][sexp-minibuffer-hook]]
...
** Package [[file:init.el#L2127][slime-company]]
...
** Package [[file:init.el#L2155][magit]]
...
** Package [[file:init.el#L2174][avy]]
...
** Package [[file:init.el#L2223][buffer-move]]
 Intuitively, this works like windmove but move buffer together with cursor.
** Package [[file:init.el#L2248][windmove]]
 Moving between window/buffer/frame/workspaces in 4 directions
  - Function [[file:init.el#L2234][next-workspace]]
  - Advice [[file:init.el#L2242][windmove-find-other-window]]: If there is an error, try framemove in that direction.
  - Package [[file:init.el#L2251][winner]]

* [[file:init.el#L2256][⭐ Multi media]]

** Package [[file:init.el#L2428][emms]]
  - Function [[file:init.el#L2279][k-emms]]: Switch to the current emms-playlist buffer, use
...
** Package [[file:init.el#L2482][ytel]]
...
* [[file:init.el#L2660][⭐ System utils]]
  ...
  - Package [[file:init.el#L2701][sudo-edit]], [[file:init.el#L2707][system-packages]]

** Package [[file:init.el#L2717][insecure-lock]]
  - Function [[file:init.el#L2712][insecure-lock-hide]]
* [[file:init.el#L2719][Org]]

** Package [[file:init.el#L2765][org]]
  - Function [[file:init.el#L2729][check-latex-fragment]], [[file:init.el#L2760][k-org-mode-hook]]
  - Package [[file:init.el#L2769][org-contrib]], [[file:init.el#L2772][org-variable-pitch]], [[file:init.el#L2776][org-superstar]], [[file:init.el#L2788][poly-org]]
  - Function [[file:init.el#L2806][k-polymode-init-inner-hook]]
  - Package [[file:init.el#L2812][engrave-faces]]

* [[file:init.el#L2852][ERC]]

** Package [[file:init.el#L2886][erc]]
...
** Package [[file:init.el#L3029][notmuch]]
  ...
  - Package [[file:init.el#L3033][smtpmail]]

* [[file:init.el#L3040][Input Method]]

** Package [[file:init.el#L3054][pyim]]
  - Function [[file:init.el#L3048][k-pyim-probe]]
  - Package [[file:init.el#L3056][pyim-basedict]], [[file:init.el#L3060][pyim-greatdict]]

* [[file:init.el#L3063][⭐ Misc handy commands]]
  - Function [[file:init.el#L3068][lookup-word]]
  - Function [[file:init.el#L3078][demolish-package]]: Nuke everything under namespace SYMBOL.
 ...
 https://gist.github.com/jdtsmith/1fbcacfe677d74bbe510aec80ac0050c
  - Function [[file:init.el#L3096][k-reraise-error]]: Call function FUNC with ARGS and re-raise any error which occurs.
...
** Package [[file:init.el#L3335][telega]]
  - Function [[file:init.el#L3235][k-telega-chatbuf-attach-sticker]]
  - Advice [[file:init.el#L3267][telega-chars-xheight]], [[file:init.el#L3272][telega-sticker--create-image]], [[file:init.el#L3280][telega--fmt-text-faces]], [[file:init.el#L3286][telega-ins--special]], [[file:init.el#L3293][telega-ins--message0]], [[file:init.el#L3300][telega-ins--date]]
  - Function [[file:init.el#L3303][k-telega-load-all-history]]: Load all history in current chat.
  - Package [[file:init.el#L3338][enwc]], [[file:init.el#L3344][proced]]
...
* [[file:init.el#L3371][⭐ Org index generation]]
  ...
  - Function [[file:init.el#L3379][k-generate-org-index]]: Read Emacs Lisp from current buffer and write org index to OUTPUT-BUFFER.
  ...
  - Function [[file:init.el#L3528][k-generate-org-index-init]]: Generate README.org from init.el.
  - Function [[file:init.el#L3554][k-generate-org-index--magit-post-stage-hook]]

* [[file:init.el#L3561][Finale]]
