...
** Package [[file:init.el#L1691][marginalia]]
 Automatically give more generous field width
  ...
  - Package [[file:init.el#L1718][orderless]], [[file:init.el#L1731][consult]]

** Package [[file:init.el#L1746][embark]]
  - Function [[file:init.el#L1764][k-grep-in]]: Grep in FILENAME.
  - Package [[file:init.el#L1772][embark-consult]]

* [[file:init.el#L1774][EXWM]]

** Package [[file:init.el#L1776][exwm]]
  - Function [[file:init.el#L1782][k-exwm-update-title]]
  - Package [[file:init.el#L1788][exwm-randr]]

* [[file:init.el#L1795][Misc key bindings]]

** [[file:init.el#L1845][More efficient bindings for keyboard macro]]
  - Package [[file:init.el#L1846][kmacro]], [[file:init.el#L1851][comment-dwim-2]], [[file:init.el#L1854][crux]]

** [[file:init.el#L1861][Disable input method (option+space) hot key on macOS]]
  - Function [[file:init.el#L1863][k-ns-toggle-input-method-shortcut]], [[file:init.el#L1870][k-ns-focus-change-function]]

* [[file:init.el#L1875][Lisp development]]
  - Package [[file:init.el#L1877][emacs]]

** Package [[file:init.el#L1890][macrostep]]
 To fix the outdated naming in (define-minor-mode macrostep-mode ...) TODO: Remove once upstream fix this.
** Package [[file:init.el#L1898][comment-or-uncomment-sexp]]
 #+nil structural comment for Common Lisp
  - Macro [[file:init.el#L1905][advance-save-excursion]], [[file:init.el#L1911][structured-comment-maybe]]
  - Function [[file:init.el#L1931][structured-comment-advice]]
  - Function [[file:init.el#L1936][structured-comment-defun]]: Use #+nil to comment a top-level form for Common Lisp.
  - Package [[file:init.el#L1949][paredit]]

** Package [[file:init.el#L1958][paxedit]]
  - Function [[file:init.el#L1966][paxedit-copy-1]], [[file:init.el#L1976][paxedit-kill-1]]
  - Advice [[file:init.el#L1992][eval-last-sexp]]

** Package [[file:init.el#L1996][slime]]
  - Advice [[file:init.el#L2013][slime-load-contribs]], [[file:init.el#L2016][slime-eval-last-expression]]

 Handy slime commands and key bindings
  - Function [[file:init.el#L2028][ensure-slime]]
  - Function [[file:init.el#L2034][slime-undefine]]: Undefine toplevel definition at point.

 *slime-scratch*
  - Function [[file:init.el#L2053][switch-to-scratch]]: Switch to scratch buffer.

 Slime mode line
  - Function [[file:init.el#L2061][slime-mode-line]]

 Hacks to make slime-autodoc works better

 Enable Paredit and Company in Lisp related minibuffers
  - Function [[file:init.el#L2070][k-slime-command-p]], [[file:init.el#L2075][sexp-minibuffer-hook]]

 Slime debug window non-prolifiration
** Package [[file:init.el#L2086][slime-repl]]
  - Function [[file:init.el#L2097][slime-repl-sync]]: Switch to Slime REPL and synchronize package/directory.
** Package [[file:init.el#L2103][slime-company]]
  - Function [[file:init.el#L2108][company-slime]]: Company mode backend for slime.
  - Package [[file:init.el#L2145][slime-mrepl]]

* [[file:init.el#L2151][Version control]]
  - Package [[file:init.el#L2153][vc-hooks]]

** Package [[file:init.el#L2157][diff-mode]]
 show whitespace in diff-mode
** Package [[file:init.el#L2168][magit]]
  - Function [[file:init.el#L2171][cloc-magit-root]]: Run Count Line Of Code for current Git repo.
** Package [[file:init.el#L2177][transient]]
 Make `transient' and thus `magit' use k-echo-area
  - Function [[file:init.el#L2183][transient--delete-window]]
  - Package [[file:init.el#L2186][smerge]]

** [[file:init.el#L2194][autosave and backup files]]

* [[file:init.el#L2201][Fast cursor movement]]

** Package [[file:init.el#L2203][avy]]
  - Function [[file:init.el#L2206][hyper-ace]], [[file:init.el#L2213][my-avy--regex-candidates]]

** Package [[file:init.el#L2220][ace-link]]
  - Function [[file:init.el#L2223][ace-link--widget-action]]
  - Function [[file:init.el#L2229][ace-link--widget-collect]]: Collect the positions of visible widgets in current buffer.
  - Function [[file:init.el#L2244][ace-link-widget]]: Open or go to a visible widget.
  - Package [[file:init.el#L2255][goto-last-change]]

* [[file:init.el#L2258][window/buffer/frame/workspaces movement]]

** Package [[file:init.el#L2260][buffer-move]]
 Intuitively, this works like windmove but move buffer together with cursor.
  - Package [[file:init.el#L2268][framemove]]

** Package [[file:init.el#L2271][windmove]]
 Moving between window/buffer/frame/workspaces in 4 directions
  - Function [[file:init.el#L2279][next-workspace]]
  - Advice [[file:init.el#L2284][windmove-find-other-window]]: If there is an error, try framemove in that direction.
  - Package [[file:init.el#L2294][winner]]

* [[file:init.el#L2299][⭐ Multi media]]

** Package [[file:init.el#L2301][emms]]
  - Function [[file:init.el#L2320][k-emms]]: Switch to the current emms-playlist buffer, use
 ...
 Patch `emms-playlist-mode-overlay-selected' so that overlay extend to full line Also set a `priority'
  - Function [[file:init.el#L2331][emms-playlist-mode-overlay-selected]]: Place an overlay over the currently selected track.

 Eye candies
  - Function [[file:init.el#L2357][k-emms-mode-line]]
  - Function [[file:init.el#L2384][k-emms-toggle-video]]: TELL MPV player to switch to video/no-video mode.
  - Function [[file:init.el#L2397][emms-playing-time-display]]: Display playing time on the mode line.
  - Function [[file:init.el#L2410][k-emms-player-mpv-event-function]], [[file:init.el#L2425][k-emms-generate-theme]], [[file:init.el#L2440][k-emms-bpm-cursor]], [[file:init.el#L2453][k-emms-bpm-cursor-stop-hook]]

** Package [[file:init.el#L2473][ytel]]
  - Function [[file:init.el#L2482][ytel--insert-video]]: Insert `VIDEO' in the current buffer.
  - Function [[file:init.el#L2496][ytel-play]]: Play video at point with EMMS.
  - Function [[file:init.el#L2504][ytel-add]]: Add video at point to EMMS playlist.

* [[file:init.el#L2527][⭐ Blink cursor]]
 It can synchronize to BPM which EMMS is playing! This works together with `k-emms-bpm-cursor'. It also uses absolute timing, otherwise Emacs timer will drift.
  - Function [[file:init.el#L2541][blink-cursor-timer-function]], [[file:init.el#L2561][k-rhythm-hit-result]]

* [[file:init.el#L2573][Scheme]]
  - Package [[file:init.el#L2575][scheme]]

** Package [[file:init.el#L2577][geiser]]
  - Function [[file:init.el#L2582][geiser-mode-maybe]]
  - Package [[file:init.el#L2588][racket-mode]]

 Terminal (vterm)

** Package [[file:init.el#L2601][vterm]]
 Ad-hoc workaround: interaction with wide fringe/padding
  - Function [[file:init.el#L2613][vterm--get-margin-width]]
  - Package [[file:init.el#L2617][multi-vterm]]

 Web browsing

** Package [[file:init.el#L2643][eww]]
  - Function [[file:init.el#L2651][k-eww-after-render-hook]]: Save `k-eww-history'.

 Move page title from header line to buffer name instead
  - Advice [[file:init.el#L2663][eww-update-header-line-format]]: Update EWW buffer title.
  - Function [[file:init.el#L2675][k-eww-read-url]]: Read URL with global history completion from `k-eww-history'.
    If inside a Google Search buffer, use the search keyword as
    default input.
  - Function [[file:init.el#L2688][eww-new-buffer]]
  - Advice [[file:init.el#L2697][url-http]]: Redirect to old.reddit.com
  - Package [[file:init.el#L2711][pdf-tools]]

** Package [[file:init.el#L2717][image-mode]]
 Disable transient map because we've already put those bindings into the main `image-mode-map'
* [[file:init.el#L2746][⭐ System utils]]
  - Function [[file:init.el#L2748][k-screenshot]]: Save a screenshot and copy its path.
  - Function [[file:init.el#L2760][k-get-volume]]: Get volume.
  - Function [[file:init.el#L2771][k-set-volume]]: Change volume.
  - Package [[file:init.el#L2785][sudo-edit]], [[file:init.el#L2792][system-packages]]

** Package [[file:init.el#L2794][insecure-lock]]
  - Function [[file:init.el#L2796][insecure-lock-hide]]
* [[file:init.el#L2804][Org]]

** Package [[file:init.el#L2806][org]]
  - Function [[file:init.el#L2813][check-latex-fragment]], [[file:init.el#L2844][k-org-mode-hook]]
  - Package [[file:init.el#L2852][org-contrib]], [[file:init.el#L2857][org-variable-pitch]], [[file:init.el#L2859][org-superstar]], [[file:init.el#L2871][poly-org]]
  - Function [[file:init.el#L2890][k-polymode-init-inner-hook]]
  - Package [[file:init.el#L2895][engrave-faces]]

* [[file:init.el#L2937][ERC]]

** Package [[file:init.el#L2939][erc]]
  - Function [[file:init.el#L2960][erc-insert-timestamp-right]]

* [[file:init.el#L2974][Email]]
  - Function [[file:init.el#L2991][insert-plist]], [[file:init.el#L3022][k-format-relative-date]]
  - Package [[file:init.el#L3039][message]]

** Package [[file:init.el#L3046][notmuch]]

 Custom email entry formatting
  - Function [[file:init.el#L3072][notmuch-search-show-result]]: Insert RESULT at POS.
  - Function [[file:init.el#L3106][k-ensure-davmail]]: Make sure davmail is running.
  - Function [[file:init.el#L3115][k-update-notmuch]]: Update email database asynchronously.
  - Package [[file:init.el#L3123][smtpmail]]

* [[file:init.el#L3133][Input Method]]

** Package [[file:init.el#L3135][pyim]]
  - Function [[file:init.el#L3140][k-pyim-probe]]
  - Package [[file:init.el#L3149][pyim-basedict]], [[file:init.el#L3151][pyim-greatdict]]

* [[file:init.el#L3156][⭐ Misc handy commands]]
  - Function [[file:init.el#L3160][lookup-word]]
  - Function [[file:init.el#L3168][demolish-package]]: Nuke everything under namespace SYMBOL.
 ...
 https://gist.github.com/jdtsmith/1fbcacfe677d74bbe510aec80ac0050c
  - Function [[file:init.el#L3186][k-reraise-error]]: Call function FUNC with ARGS and re-raise any error which occurs.
    Useful for debugging post-command hooks and filter functions, which
    normally have their errors suppressed.
  - Function [[file:init.el#L3194][toggle-debug-on-hidden-errors]]: Toggle hidden error debugging for function FUNC.
  - Function [[file:init.el#L3205][k-straight-freeze-versions]]: Run `straight-freeze-versions' asynchronously in Emacs subprocess.

* [[file:init.el#L3215][⭐ Status area]]
 ...
 A status area at the right bottom corner (using the right side of global echo area).  It is used for displaying battery, time, and vampire time zone.
  - Function [[file:init.el#L3223][k-time-status]]: Status function for current time.
  - Function [[file:init.el#L3227][k-battery-status]]: Status function for battery status.
  - Function [[file:init.el#L3250][k-status-update]]: Update status area.

* [[file:init.el#L3273][Vampire timezone]]
 How much sun-protection-free time left?
  - Function [[file:init.el#L3281][time-to-vampire-time]]
  - Function [[file:init.el#L3293][vampire-time-status]]: Status function for vampire time zone.

* [[file:init.el#L3312][telega.el]]
 A heavily modified telega.el to tweak its appearance to my liking.

** Package [[file:init.el#L3319][telega]]
  - Function [[file:init.el#L3327][k-telega-chatbuf-attach-sticker]]
  - Advice [[file:init.el#L3358][telega-chars-xheight]], [[file:init.el#L3363][telega-sticker--create-image]], [[file:init.el#L3372][telega--fmt-text-faces]], [[file:init.el#L3378][telega-ins--special]], [[file:init.el#L3385][telega-ins--message0]], [[file:init.el#L3392][telega-ins--date]]
  - Function [[file:init.el#L3395][k-telega-load-all-history]]: Load all history in current chat.
  - Package [[file:init.el#L3430][enwc]], [[file:init.el#L3435][proced]]

* [[file:init.el#L3448][Undo Tree]]
  - Package [[file:init.el#L3450][undo-tree]]

** Package [[file:init.el#L3465][vundo]]
 Let vundo split a window on top instead
  - Function [[file:init.el#L3471][vundo]]: Display visual undo for the current buffer.

 `jit-lock-mode' need to be passed nil to turn off
  - Package [[file:init.el#L3508][undo-fu-session]]

* [[file:init.el#L3511][⭐ Org index generation]]
  - Package [[file:init.el#L3513][toc-org]]
  - Function [[file:init.el#L3515][k-generate-org-index]]: Read Emacs Lisp from current buffer and write org index to OUTPUT-BUFFER.
  ...
  - Function [[file:init.el#L3669][k-generate-org-index-init]]: Generate README.org from init.el.
  - Function [[file:init.el#L3695][k-generate-org-index--magit-post-stage-hook]]

* [[file:init.el#L3703][Finale]]
