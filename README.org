...
** Package [[file:init.el#L1767][embark]]
  - Function [[file:init.el#L1782][k-grep-in-1]]: Grep in current embark target.
...
* [[file:init.el#L2187][Version control]]
  - Package [[file:init.el#L2189][vc-hooks]]

** Package [[file:init.el#L2193][diff-mode]]
 show whitespace in diff-mode
** Package [[file:init.el#L2204][magit]]
  - Function [[file:init.el#L2207][cloc-magit-root]]: Run Count Line Of Code for current Git repo.
** Package [[file:init.el#L2213][transient]]
 Make `transient' and thus `magit' use k-echo-area
  - Function [[file:init.el#L2219][transient--delete-window]]
  - Package [[file:init.el#L2222][smerge]]
...
** Package [[file:init.el#L2663][vterm]]
 Ad-hoc workaround: interaction with wide fringe/padding
  ...
  - Package [[file:init.el#L2679][multi-vterm]]

 Web browsing

** Package [[file:init.el#L2697][exwm]]
  - Function [[file:init.el#L2701][k-browse-url-chromium]]

** Package [[file:init.el#L2707][eww]]
  - Function [[file:init.el#L2715][k-eww-after-render-hook]]: Save `k-eww-history'.

 Move page title from header line to buffer name instead
  - Advice [[file:init.el#L2727][eww-update-header-line-format]]: Update EWW buffer title.
  - Function [[file:init.el#L2739][k-eww-read-url]]: Read URL with global history completion from `k-eww-history'.
    If inside a Google Search buffer, use the search keyword as
    default input.
  - Function [[file:init.el#L2752][eww-new-buffer]]
  - Advice [[file:init.el#L2761][url-http]]: Redirect to old.reddit.com
** Package [[file:init.el#L2767][exwm]]
  - Function [[file:init.el#L2771][k-eww-reload-in-chromium]]
  - Package [[file:init.el#L2778][pdf-tools]]

** Package [[file:init.el#L2784][image-mode]]
 Disable transient map because we've already put those bindings into the main `image-mode-map'
* [[file:init.el#L2813][⭐ System utils]]
  - Function [[file:init.el#L2815][k-screenshot]]: Save a screenshot and copy its path.
  - Function [[file:init.el#L2827][k-get-volume]]: Get volume.
  - Function [[file:init.el#L2838][k-set-volume]]: Change volume.
  - Package [[file:init.el#L2852][sudo-edit]], [[file:init.el#L2859][system-packages]]

** Package [[file:init.el#L2861][insecure-lock]]
  - Function [[file:init.el#L2863][insecure-lock-hide]]
* [[file:init.el#L2871][Org]]

** Package [[file:init.el#L2873][org]]
  - Function [[file:init.el#L2880][check-latex-fragment]], [[file:init.el#L2911][k-org-mode-hook]]
  - Package [[file:init.el#L2919][org-contrib]], [[file:init.el#L2924][org-variable-pitch]], [[file:init.el#L2926][org-superstar]], [[file:init.el#L2938][poly-org]]
  - Function [[file:init.el#L2957][k-polymode-init-inner-hook]]
  - Package [[file:init.el#L2962][engrave-faces]]

* [[file:init.el#L3004][ERC]]

** Package [[file:init.el#L3006][erc]]
  - Function [[file:init.el#L3027][erc-insert-timestamp-right]]

* [[file:init.el#L3041][Email]]
  - Function [[file:init.el#L3058][insert-plist]], [[file:init.el#L3089][k-format-relative-date]]
  - Package [[file:init.el#L3106][message]]

** Package [[file:init.el#L3113][notmuch]]

 Custom email entry formatting
  - Function [[file:init.el#L3139][notmuch-search-show-result]]: Insert RESULT at POS.
  - Function [[file:init.el#L3173][k-ensure-davmail]]: Make sure davmail is running.
  - Function [[file:init.el#L3185][k-update-notmuch-unread-count]]
  - Function [[file:init.el#L3187][k-update-notmuch]]: Update email database asynchronously.
  - Function [[file:init.el#L3207][k-notmuch-unread-status]]
  - Package [[file:init.el#L3214][smtpmail]]

* [[file:init.el#L3224][Input Method]]

** Package [[file:init.el#L3226][pyim]]
  - Function [[file:init.el#L3231][k-pyim-probe]]
  - Package [[file:init.el#L3240][pyim-basedict]], [[file:init.el#L3242][pyim-greatdict]]

* [[file:init.el#L3247][⭐ Misc handy commands]]
  - Function [[file:init.el#L3251][lookup-word]]
  - Function [[file:init.el#L3259][demolish-package]]: Nuke everything under namespace SYMBOL.
 ...
 https://gist.github.com/jdtsmith/1fbcacfe677d74bbe510aec80ac0050c
  - Function [[file:init.el#L3277][k-reraise-error]]: Call function FUNC with ARGS and re-raise any error which occurs.
    Useful for debugging post-command hooks and filter functions, which
    normally have their errors suppressed.
  - Function [[file:init.el#L3285][toggle-debug-on-hidden-errors]]: Toggle hidden error debugging for function FUNC.
  - Function [[file:init.el#L3296][k-straight-freeze-versions]]: Run `straight-freeze-versions' asynchronously in Emacs subprocess.

* [[file:init.el#L3306][⭐ Status area]]
 ...
 A status area at the right bottom corner (using the right side of global echo area).  It is used for displaying battery, time, and vampire time zone.
  - Function [[file:init.el#L3314][k-time-status]]: Status function for current time.
  - Function [[file:init.el#L3318][k-battery-status]]: Status function for battery status.
  - Function [[file:init.el#L3341][k-status-update]]: Update status area.

* [[file:init.el#L3364][Vampire timezone]]
 How much sun-protection-free time left?
  - Function [[file:init.el#L3372][time-to-vampire-time]]
  - Function [[file:init.el#L3384][vampire-time-status]]: Status function for vampire time zone.

* [[file:init.el#L3403][telega.el]]
 A heavily modified telega.el to tweak its appearance to my liking.

** Package [[file:init.el#L3410][telega]]
  - Function [[file:init.el#L3418][k-telega-chatbuf-attach-sticker]]
  - Advice [[file:init.el#L3449][telega-chars-xheight]], [[file:init.el#L3454][telega-sticker--create-image]], [[file:init.el#L3463][telega--fmt-text-faces]], [[file:init.el#L3469][telega-ins--special]], [[file:init.el#L3476][telega-ins--message0]], [[file:init.el#L3483][telega-ins--date]]
  - Function [[file:init.el#L3486][k-telega-load-all-history]]: Load all history in current chat.
  - Package [[file:init.el#L3521][enwc]], [[file:init.el#L3526][proced]]

* [[file:init.el#L3539][Undo Tree]]
  - Package [[file:init.el#L3541][undo-tree]]

** Package [[file:init.el#L3556][vundo]]
 Let vundo use k-echo-area
  - Function [[file:init.el#L3563][vundo]]: Display visual undo for the current buffer.
  - Function [[file:init.el#L3582][k-vundo-kill-buffer-advice]]: Let vundo use `k-echo-area-clear-1' instead of `kill-buffer-and-window'.
    The latter would also delete the main window because it is atomic
    with k-echo-area.

 `jit-lock-mode' need to be passed nil to turn off
  - Package [[file:init.el#L3612][undo-fu-session]]

* [[file:init.el#L3615][⭐ Org index generation]]
  - Package [[file:init.el#L3617][toc-org]]
  - Function [[file:init.el#L3619][k-generate-org-index]]: Read Emacs Lisp from current buffer and write org index to OUTPUT-BUFFER.
  ...
  - Function [[file:init.el#L3773][k-generate-org-index-init]]: Generate README.org from init.el.
  - Function [[file:init.el#L3799][k-generate-org-index--magit-post-stage-hook]]

* [[file:init.el#L3807][Finale]]
