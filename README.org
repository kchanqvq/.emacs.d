...
** Package [[file:init.el#L1767][embark]]
  - Function [[file:init.el#L1783][k-grep-in-1]]
  - Function [[file:init.el#L1786][k-grep-in]]: Grep in FILENAME.
  - Package [[file:init.el#L1794][embark-consult]]

* [[file:init.el#L1796][EXWM]]
  - Package [[file:init.el#L1798][exwm-randr]]

** Package [[file:init.el#L1805][exwm]]
  - Function [[file:init.el#L1811][k-exwm-update-title]]

* [[file:init.el#L1818][Misc key bindings]]

** [[file:init.el#L1868][More efficient bindings for keyboard macro]]
  - Package [[file:init.el#L1869][kmacro]], [[file:init.el#L1874][comment-dwim-2]], [[file:init.el#L1877][crux]]

** [[file:init.el#L1884][Disable input method (option+space) hot key on macOS]]
  - Function [[file:init.el#L1886][k-ns-toggle-input-method-shortcut]], [[file:init.el#L1893][k-ns-focus-change-function]]

* [[file:init.el#L1898][Lisp development]]

** Package [[file:init.el#L1900][emacs]]
  - Function [[file:init.el#L1915][k-info-rename-buffer]]: Rename info buffer according to current node.
  - Advice [[file:init.el#L1919][eval-last-sexp]]

** Package [[file:init.el#L1926][macrostep]]
 To fix the outdated naming in (define-minor-mode macrostep-mode ...) TODO: Remove once upstream fix this.
** Package [[file:init.el#L1934][comment-or-uncomment-sexp]]
 #+nil structural comment for Common Lisp
  - Macro [[file:init.el#L1941][advance-save-excursion]], [[file:init.el#L1947][structured-comment-maybe]]
  - Function [[file:init.el#L1967][structured-comment-advice]]
  - Function [[file:init.el#L1972][structured-comment-defun]]: Use #+nil to comment a top-level form for Common Lisp.
  - Package [[file:init.el#L1985][paredit]]

** Package [[file:init.el#L1994][paxedit]]
  - Function [[file:init.el#L2002][paxedit-copy-1]], [[file:init.el#L2012][paxedit-kill-1]]
  - Advice [[file:init.el#L2028][eval-last-sexp]]

** Package [[file:init.el#L2032][slime]]
  - Advice [[file:init.el#L2049][slime-load-contribs]], [[file:init.el#L2052][slime-eval-last-expression]]

 Handy slime commands and key bindings
  - Function [[file:init.el#L2063][ensure-slime]]
  - Function [[file:init.el#L2069][slime-undefine]]: Undefine toplevel definition at point.

 *slime-scratch*
  - Function [[file:init.el#L2088][switch-to-scratch]]: Switch to scratch buffer.

 Slime mode line
  - Function [[file:init.el#L2096][slime-mode-line]]

 Hacks to make slime-autodoc works better

 Enable Paredit and Company in Lisp related minibuffers
  - Function [[file:init.el#L2105][k-slime-command-p]], [[file:init.el#L2110][sexp-minibuffer-hook]]

 Slime debug window non-prolifiration
** Package [[file:init.el#L2121][slime-repl]]
  - Function [[file:init.el#L2132][slime-repl-sync]]: Switch to Slime REPL and synchronize package/directory.
** Package [[file:init.el#L2138][slime-company]]
  - Function [[file:init.el#L2143][company-slime]]: Company mode backend for slime.
  - Package [[file:init.el#L2180][slime-mrepl]]

* [[file:init.el#L2182][Version control]]
  - Package [[file:init.el#L2184][vc-hooks]]

** Package [[file:init.el#L2188][diff-mode]]
 show whitespace in diff-mode
** Package [[file:init.el#L2199][magit]]
  - Function [[file:init.el#L2202][cloc-magit-root]]: Run Count Line Of Code for current Git repo.
** Package [[file:init.el#L2208][transient]]
 Make `transient' and thus `magit' use k-echo-area
  - Function [[file:init.el#L2214][transient--delete-window]]
  - Package [[file:init.el#L2217][smerge]]

** [[file:init.el#L2225][autosave and backup files]]

* [[file:init.el#L2232][Fast cursor movement]]

** Package [[file:init.el#L2234][avy]]
  - Function [[file:init.el#L2237][hyper-ace]], [[file:init.el#L2244][my-avy--regex-candidates]]

** Package [[file:init.el#L2251][ace-link]]
  - Function [[file:init.el#L2254][ace-link--widget-action]]
  - Function [[file:init.el#L2260][ace-link--widget-collect]]: Collect the positions of visible widgets in current buffer.
  - Function [[file:init.el#L2275][ace-link-widget]]: Open or go to a visible widget.
  - Package [[file:init.el#L2287][goto-last-change]]

* [[file:init.el#L2290][window/buffer/frame/workspaces movement]]

** Package [[file:init.el#L2292][buffer-move]]
 Intuitively, this works like windmove but move buffer together with cursor.
  - Package [[file:init.el#L2300][framemove]]

** Package [[file:init.el#L2303][windmove]]
 Moving between window/buffer/frame/workspaces in 4 directions
  - Function [[file:init.el#L2311][next-workspace]]
  - Advice [[file:init.el#L2316][windmove-find-other-window]]: If there is an error, try framemove in that direction.
  - Package [[file:init.el#L2326][winner]]

* [[file:init.el#L2331][⭐ Multi media]]

** Package [[file:init.el#L2335][emms]]
  - Function [[file:init.el#L2354][k-emms]]: Switch to the current emms-playlist buffer, use
    emms-playlist-mode and query for a playlist to open.
  - Function [[file:init.el#L2365][k-emms-save]]: Save emms playlist buffer.

 Eye candies
  - Function [[file:init.el#L2377][k-emms-mode-line]]
  - Function [[file:init.el#L2406][k-emms-toggle-video]]: TELL MPV player to switch to video/no-video mode.
  - Function [[file:init.el#L2419][emms-playing-time-display]]: Display playing time on the mode line.
  - Function [[file:init.el#L2432][k-emms-player-mpv-event-function]], [[file:init.el#L2447][k-emms-generate-theme]], [[file:init.el#L2462][k-emms-bpm-cursor]], [[file:init.el#L2475][k-emms-bpm-cursor-stop-hook]]

** Package [[file:init.el#L2486][emms-playlist-mode]]
 Patch `emms-playlist-mode-overlay-selected' so that overlay extend to full line Also set a `priority'
  - Function [[file:init.el#L2491][emms-playlist-mode-overlay-selected]]: Place an overlay over the currently selected track.
** Package [[file:init.el#L2512][exwm]]
  - Function [[file:init.el#L2515][k-exwm-update-class]]: Custom window management.
    Put mpv windows in the background as dynamic wallpapers.
    Hide davmail windows on startup.
** Package [[file:init.el#L2528][ytel]]
 Custom video entry formatting
  - Function [[file:init.el#L2538][ytel--insert-video]]: Insert `VIDEO' in the current buffer.
  - Function [[file:init.el#L2553][ytel-play]]: Play video at point with EMMS.
  - Function [[file:init.el#L2561][ytel-add]]: Add video at point to EMMS playlist.

* [[file:init.el#L2584][⭐ Blink cursor]]
 It can synchronize to BPM which EMMS is playing! This works together with `k-emms-bpm-cursor'. It also uses absolute timing, otherwise Emacs timer will drift.
  - Function [[file:init.el#L2598][blink-cursor-timer-function]], [[file:init.el#L2618][k-rhythm-hit-result]]

* [[file:init.el#L2630][Scheme]]
  - Package [[file:init.el#L2632][scheme]]

** Package [[file:init.el#L2634][geiser]]
  - Function [[file:init.el#L2639][geiser-mode-maybe]]
  - Package [[file:init.el#L2645][racket-mode]]

 Terminal (vterm)

** Package [[file:init.el#L2658][vterm]]
 Ad-hoc workaround: interaction with wide fringe/padding
  - Function [[file:init.el#L2670][vterm--get-margin-width]]

** Package [[file:init.el#L2688][unix-in-slime]]
  - Function [[file:init.el#L2693][unix-in-slime-next]]
 Web browsing

** Package [[file:init.el#L2707][exwm]]
  - Function [[file:init.el#L2711][k-browse-url-chromium]]

** Package [[file:init.el#L2717][eww]]
  - Function [[file:init.el#L2725][k-eww-after-render-hook]]: Save `k-eww-history'.

 Move page title from header line to buffer name instead
  - Advice [[file:init.el#L2737][eww-update-header-line-format]]: Update EWW buffer title.
  - Function [[file:init.el#L2749][k-eww-read-url]]: Read URL with global history completion from `k-eww-history'.
    If inside a Google Search buffer, use the search keyword as
    default input.
  - Function [[file:init.el#L2762][eww-new-buffer]]
  - Advice [[file:init.el#L2773][url-http]]: Redirect to old.reddit.com
** Package [[file:init.el#L2779][exwm]]
  - Function [[file:init.el#L2783][k-eww-reload-in-chromium]]
  - Package [[file:init.el#L2790][pdf-tools]]

** Package [[file:init.el#L2796][image-mode]]
 Disable transient map because we've already put those bindings into the main `image-mode-map'
* [[file:init.el#L2825][⭐ System utils]]
  - Function [[file:init.el#L2827][k-screenshot]]: Save a screenshot and copy its path.
  - Function [[file:init.el#L2839][k-get-volume]]: Get volume.
  - Function [[file:init.el#L2850][k-set-volume]]: Change volume.
  - Package [[file:init.el#L2864][sudo-edit]], [[file:init.el#L2871][system-packages]]

** Package [[file:init.el#L2873][insecure-lock]]
  - Function [[file:init.el#L2875][insecure-lock-hide]]
* [[file:init.el#L2883][Org]]

** Package [[file:init.el#L2885][org]]
  - Function [[file:init.el#L2892][check-latex-fragment]], [[file:init.el#L2923][k-org-mode-hook]]
  - Package [[file:init.el#L2931][org-contrib]], [[file:init.el#L2936][org-variable-pitch]], [[file:init.el#L2938][org-superstar]], [[file:init.el#L2950][poly-org]]
  - Function [[file:init.el#L2969][k-polymode-init-inner-hook]]
  - Package [[file:init.el#L2974][engrave-faces]]

* [[file:init.el#L3016][ERC]]

** Package [[file:init.el#L3018][erc]]
  - Function [[file:init.el#L3039][erc-insert-timestamp-right]]

* [[file:init.el#L3053][Email]]
  - Function [[file:init.el#L3070][insert-plist]], [[file:init.el#L3101][k-format-relative-date]]
  - Package [[file:init.el#L3118][message]]

** Package [[file:init.el#L3125][notmuch]]

 Custom email entry formatting
  - Function [[file:init.el#L3151][notmuch-search-show-result]]: Insert RESULT at POS.
  - Function [[file:init.el#L3185][k-ensure-davmail]]: Make sure davmail is running.
  - Function [[file:init.el#L3197][k-update-notmuch-unread-count]]
  - Function [[file:init.el#L3199][k-update-notmuch]]: Update email database asynchronously.
  - Function [[file:init.el#L3220][k-notmuch-unread-status]]
  - Package [[file:init.el#L3227][smtpmail]]

* [[file:init.el#L3237][Input Method]]

** Package [[file:init.el#L3239][pyim]]
  - Function [[file:init.el#L3244][k-pyim-probe]]
  - Package [[file:init.el#L3253][pyim-basedict]], [[file:init.el#L3255][pyim-greatdict]]

* [[file:init.el#L3260][⭐ Misc handy commands]]
  - Function [[file:init.el#L3264][lookup-word]]
  - Function [[file:init.el#L3272][demolish-package]]: Nuke everything under namespace SYMBOL.
 ...
 https://gist.github.com/jdtsmith/1fbcacfe677d74bbe510aec80ac0050c
  - Function [[file:init.el#L3290][k-reraise-error]]: Call function FUNC with ARGS and re-raise any error which occurs.
    Useful for debugging post-command hooks and filter functions, which
    normally have their errors suppressed.
  - Function [[file:init.el#L3298][toggle-debug-on-hidden-errors]]: Toggle hidden error debugging for function FUNC.
  - Function [[file:init.el#L3309][k-straight-freeze-versions]]: Run `straight-freeze-versions' asynchronously in Emacs subprocess.

* [[file:init.el#L3319][⭐ Status area]]
 ...
 A status area at the right bottom corner (using the right side of global echo area).  It is used for displaying battery, time, and vampire time zone.
  - Function [[file:init.el#L3327][k-time-status]]: Status function for current time.
  - Function [[file:init.el#L3331][k-battery-status]]: Status function for battery status.
  - Function [[file:init.el#L3354][k-status-update]]: Update status area.

* [[file:init.el#L3377][Vampire timezone]]
 How much sun-protection-free time left?
  - Function [[file:init.el#L3385][time-to-vampire-time]]
  - Function [[file:init.el#L3397][vampire-time-status]]: Status function for vampire time zone.

* [[file:init.el#L3416][telega.el]]
 A heavily modified telega.el to tweak its appearance to my liking.

** Package [[file:init.el#L3423][telega]]
  - Function [[file:init.el#L3431][k-telega-chatbuf-attach-sticker]]
  - Advice [[file:init.el#L3462][telega-chars-xheight]], [[file:init.el#L3467][telega-sticker--create-image]], [[file:init.el#L3476][telega--fmt-text-faces]], [[file:init.el#L3482][telega-ins--special]], [[file:init.el#L3489][telega-ins--message0]], [[file:init.el#L3496][telega-ins--date]]
  - Function [[file:init.el#L3499][k-telega-load-all-history]]: Load all history in current chat.
  - Package [[file:init.el#L3534][enwc]], [[file:init.el#L3539][proced]]

* [[file:init.el#L3552][Undo Tree]]
  - Package [[file:init.el#L3554][undo-tree]]

** Package [[file:init.el#L3569][vundo]]
 Let vundo use k-echo-area
  - Function [[file:init.el#L3576][vundo]]: Display visual undo for the current buffer.
  - Function [[file:init.el#L3595][k-vundo-kill-buffer-advice]]: Let vundo use `k-echo-area-clear-1' instead of `kill-buffer-and-window'.
    The latter would also delete the main window because it is atomic
    with k-echo-area.

 `jit-lock-mode' need to be passed nil to turn off
  - Package [[file:init.el#L3625][undo-fu-session]]

* [[file:init.el#L3628][⭐ Org index generation]]
  - Package [[file:init.el#L3630][toc-org]]
  - Function [[file:init.el#L3632][k-generate-org-index]]: Read Emacs Lisp from current buffer and write org index to OUTPUT-BUFFER.
  ...
  - Function [[file:init.el#L3786][k-generate-org-index-init]]: Generate README.org from init.el.
  - Function [[file:init.el#L3812][k-generate-org-index--magit-post-stage-hook]]

* [[file:init.el#L3820][Finale]]
