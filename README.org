...
** Package [[file:init.el#L2729][unix-in-slime]]
  - Function [[file:init.el#L2734][unix-in-slime-next]]
 Web browsing

** Package [[file:init.el#L2748][exwm]]
  - Function [[file:init.el#L2752][k-browse-url-chromium]]

** Package [[file:init.el#L2758][eww]]
  - Function [[file:init.el#L2766][k-eww-after-render-hook]]: Save `k-eww-history'.

 Move page title from header line to buffer name instead
  - Advice [[file:init.el#L2778][eww-update-header-line-format]]: Update EWW buffer title.
  - Function [[file:init.el#L2790][k-eww-read-url]]: Read URL with global history completion from `k-eww-history'.
    If inside a Google Search buffer, use the search keyword as
    default input.
  - Function [[file:init.el#L2803][eww-new-buffer]]
  - Advice [[file:init.el#L2814][url-http]]: Redirect to old.reddit.com
** Package [[file:init.el#L2820][exwm]]
  - Function [[file:init.el#L2824][k-eww-reload-in-chromium]]
  - Package [[file:init.el#L2831][pdf-tools]]
...
* [[file:init.el#L2866][⭐ System utils]]
  ...
  - Package [[file:init.el#L2905][sudo-edit]], [[file:init.el#L2912][system-packages]]

** Package [[file:init.el#L2914][insecure-lock]]
  - Function [[file:init.el#L2916][insecure-lock-hide]]
* [[file:init.el#L2924][Org]]

** Package [[file:init.el#L2926][org]]
  - Function [[file:init.el#L2933][check-latex-fragment]], [[file:init.el#L2964][k-org-mode-hook]]
  - Package [[file:init.el#L2972][org-contrib]], [[file:init.el#L2977][org-variable-pitch]], [[file:init.el#L2979][org-superstar]], [[file:init.el#L2991][poly-org]]
  - Function [[file:init.el#L3010][k-polymode-init-inner-hook]]
  - Package [[file:init.el#L3015][engrave-faces]]

* [[file:init.el#L3057][ERC]]

** Package [[file:init.el#L3059][erc]]
  - Function [[file:init.el#L3080][erc-insert-timestamp-right]]

* [[file:init.el#L3094][Email]]
  - Function [[file:init.el#L3111][insert-plist]], [[file:init.el#L3142][k-format-relative-date]]
  - Package [[file:init.el#L3159][message]]

** Package [[file:init.el#L3166][notmuch]]

 Custom email entry formatting
  - Function [[file:init.el#L3192][notmuch-search-show-result]]: Insert RESULT at POS.
  - Function [[file:init.el#L3226][k-ensure-davmail]]: Make sure davmail is running.
  - Function [[file:init.el#L3238][k-update-notmuch-unread-count]]
  - Function [[file:init.el#L3240][k-update-notmuch]]: Update email database asynchronously.
  - Function [[file:init.el#L3261][k-notmuch-unread-status]]
  - Package [[file:init.el#L3268][smtpmail]]

* [[file:init.el#L3278][Input Method]]

** Package [[file:init.el#L3280][pyim]]
  - Function [[file:init.el#L3285][k-pyim-probe]]
  - Package [[file:init.el#L3294][pyim-basedict]], [[file:init.el#L3296][pyim-greatdict]]

* [[file:init.el#L3301][⭐ Misc handy commands]]
  - Function [[file:init.el#L3305][lookup-word]]
  - Function [[file:init.el#L3313][demolish-package]]: Nuke everything under namespace SYMBOL.
 ...
 https://gist.github.com/jdtsmith/1fbcacfe677d74bbe510aec80ac0050c
  - Function [[file:init.el#L3331][k-reraise-error]]: Call function FUNC with ARGS and re-raise any error which occurs.
    Useful for debugging post-command hooks and filter functions, which
    normally have their errors suppressed.
  - Function [[file:init.el#L3339][toggle-debug-on-hidden-errors]]: Toggle hidden error debugging for function FUNC.
  - Function [[file:init.el#L3350][k-straight-freeze-versions]]: Run `straight-freeze-versions' asynchronously in Emacs subprocess.

* [[file:init.el#L3360][⭐ Status area]]
 ...
 A status area at the right bottom corner (using the right side of global echo area).  It is used for displaying battery, time, and vampire time zone.
  - Function [[file:init.el#L3368][k-time-status]]: Status function for current time.
  - Function [[file:init.el#L3372][k-battery-status]]: Status function for battery status.
  - Function [[file:init.el#L3395][k-status-update]]: Update status area.

* [[file:init.el#L3418][Vampire timezone]]
 How much sun-protection-free time left?
  - Function [[file:init.el#L3426][time-to-vampire-time]]
  - Function [[file:init.el#L3438][vampire-time-status]]: Status function for vampire time zone.

* [[file:init.el#L3457][telega.el]]
 A heavily modified telega.el to tweak its appearance to my liking.

** Package [[file:init.el#L3464][telega]]
  - Function [[file:init.el#L3472][k-telega-chatbuf-attach-sticker]]
  - Advice [[file:init.el#L3503][telega-chars-xheight]], [[file:init.el#L3508][telega-sticker--create-image]], [[file:init.el#L3517][telega--fmt-text-faces]], [[file:init.el#L3523][telega-ins--special]], [[file:init.el#L3530][telega-ins--message0]], [[file:init.el#L3537][telega-ins--date]]
  - Function [[file:init.el#L3540][k-telega-load-all-history]]: Load all history in current chat.
  - Package [[file:init.el#L3575][enwc]], [[file:init.el#L3580][proced]]

* [[file:init.el#L3593][Undo Tree]]
  - Package [[file:init.el#L3595][undo-tree]]

** Package [[file:init.el#L3610][vundo]]
 Let vundo use k-echo-area
  - Function [[file:init.el#L3620][vundo]]: Display visual undo for the current buffer.
  - Function [[file:init.el#L3639][k-vundo-kill-buffer-advice]]: Let vundo use `k-echo-area-clear-1' instead of `kill-buffer-and-window'.
    The latter would also delete the main window because it is atomic
    with k-echo-area.

 `jit-lock-mode' need to be passed nil to turn off
  - Package [[file:init.el#L3669][undo-fu-session]]

* [[file:init.el#L3672][⭐ Org index generation]]
  - Package [[file:init.el#L3674][toc-org]]
  - Function [[file:init.el#L3676][k-generate-org-index]]: Read Emacs Lisp from current buffer and write org index to OUTPUT-BUFFER.
  ...
  - Function [[file:init.el#L3830][k-generate-org-index-init]]: Generate README.org from init.el.
  - Function [[file:init.el#L3856][k-generate-org-index--magit-post-stage-hook]]

* [[file:init.el#L3864][Finale]]
