 ...
 *slime-scratch*
 ...
 Enable Paredit and Company in Lisp related minibuffers
  - Function [[file:init.el#L2124][k-slime-command-p]], [[file:init.el#L2130][sexp-minibuffer-hook]]
...
** Package [[file:init.el#L2675][geiser]]
  ...
  - Package [[file:init.el#L2686][racket-mode]]

 Terminal (vterm)

** Package [[file:init.el#L2699][vterm]]
 Ad-hoc workaround: interaction with wide fringe/padding
  - Function [[file:init.el#L2711][vterm--get-margin-width]]
  - Package [[file:init.el#L2729][unix-in-slime]]
...
** Package [[file:init.el#L2829][image-mode]]
 Disable transient map because we've already put those bindings into the main `image-mode-map'
* [[file:init.el#L2858][⭐ System utils]]
  - Function [[file:init.el#L2860][k-screenshot]]: Save a screenshot and copy its path.
  - Function [[file:init.el#L2872][k-get-volume]]: Get volume.
  - Function [[file:init.el#L2883][k-set-volume]]: Change volume.
  - Package [[file:init.el#L2897][sudo-edit]], [[file:init.el#L2904][system-packages]]

** Package [[file:init.el#L2906][insecure-lock]]
  - Function [[file:init.el#L2908][insecure-lock-hide]]
* [[file:init.el#L2916][Org]]

** Package [[file:init.el#L2918][org]]
  - Function [[file:init.el#L2925][check-latex-fragment]], [[file:init.el#L2956][k-org-mode-hook]]
  - Package [[file:init.el#L2964][org-contrib]], [[file:init.el#L2969][org-variable-pitch]], [[file:init.el#L2971][org-superstar]], [[file:init.el#L2983][poly-org]]
  - Function [[file:init.el#L3002][k-polymode-init-inner-hook]]
  - Package [[file:init.el#L3007][engrave-faces]]

* [[file:init.el#L3049][ERC]]

** Package [[file:init.el#L3051][erc]]
  - Function [[file:init.el#L3072][erc-insert-timestamp-right]]

* [[file:init.el#L3086][Email]]
  - Function [[file:init.el#L3103][insert-plist]], [[file:init.el#L3134][k-format-relative-date]]
  - Package [[file:init.el#L3151][message]]

** Package [[file:init.el#L3158][notmuch]]

 Custom email entry formatting
  - Function [[file:init.el#L3184][notmuch-search-show-result]]: Insert RESULT at POS.
  - Function [[file:init.el#L3218][k-ensure-davmail]]: Make sure davmail is running.
  - Function [[file:init.el#L3230][k-update-notmuch-unread-count]]
  - Function [[file:init.el#L3232][k-update-notmuch]]: Update email database asynchronously.
  - Function [[file:init.el#L3253][k-notmuch-unread-status]]
  - Package [[file:init.el#L3260][smtpmail]]

* [[file:init.el#L3270][Input Method]]

** Package [[file:init.el#L3272][pyim]]
  - Function [[file:init.el#L3277][k-pyim-probe]]
  - Package [[file:init.el#L3286][pyim-basedict]], [[file:init.el#L3288][pyim-greatdict]]

* [[file:init.el#L3293][⭐ Misc handy commands]]
  - Function [[file:init.el#L3297][lookup-word]]
  - Function [[file:init.el#L3305][demolish-package]]: Nuke everything under namespace SYMBOL.
 ...
 https://gist.github.com/jdtsmith/1fbcacfe677d74bbe510aec80ac0050c
  - Function [[file:init.el#L3323][k-reraise-error]]: Call function FUNC with ARGS and re-raise any error which occurs.
    Useful for debugging post-command hooks and filter functions, which
    normally have their errors suppressed.
  - Function [[file:init.el#L3331][toggle-debug-on-hidden-errors]]: Toggle hidden error debugging for function FUNC.
  - Function [[file:init.el#L3342][k-straight-freeze-versions]]: Run `straight-freeze-versions' asynchronously in Emacs subprocess.

* [[file:init.el#L3352][⭐ Status area]]
 ...
 A status area at the right bottom corner (using the right side of global echo area).  It is used for displaying battery, time, and vampire time zone.
  - Function [[file:init.el#L3360][k-time-status]]: Status function for current time.
  - Function [[file:init.el#L3364][k-battery-status]]: Status function for battery status.
  - Function [[file:init.el#L3387][k-status-update]]: Update status area.

* [[file:init.el#L3410][Vampire timezone]]
 How much sun-protection-free time left?
  - Function [[file:init.el#L3418][time-to-vampire-time]]
  - Function [[file:init.el#L3430][vampire-time-status]]: Status function for vampire time zone.

* [[file:init.el#L3449][telega.el]]
 A heavily modified telega.el to tweak its appearance to my liking.

** Package [[file:init.el#L3456][telega]]
  - Function [[file:init.el#L3464][k-telega-chatbuf-attach-sticker]]
  - Advice [[file:init.el#L3495][telega-chars-xheight]], [[file:init.el#L3500][telega-sticker--create-image]], [[file:init.el#L3509][telega--fmt-text-faces]], [[file:init.el#L3515][telega-ins--special]], [[file:init.el#L3522][telega-ins--message0]], [[file:init.el#L3529][telega-ins--date]]
  - Function [[file:init.el#L3532][k-telega-load-all-history]]: Load all history in current chat.
  - Package [[file:init.el#L3567][enwc]], [[file:init.el#L3572][proced]]

* [[file:init.el#L3585][Undo Tree]]
  - Package [[file:init.el#L3587][undo-tree]]

** Package [[file:init.el#L3602][vundo]]
 Let vundo use k-echo-area
  - Function [[file:init.el#L3612][vundo]]: Display visual undo for the current buffer.
  - Function [[file:init.el#L3631][k-vundo-kill-buffer-advice]]: Let vundo use `k-echo-area-clear-1' instead of `kill-buffer-and-window'.
    The latter would also delete the main window because it is atomic
    with k-echo-area.

 `jit-lock-mode' need to be passed nil to turn off
  - Package [[file:init.el#L3661][undo-fu-session]]

* [[file:init.el#L3664][⭐ Org index generation]]
  - Package [[file:init.el#L3666][toc-org]]
  - Function [[file:init.el#L3668][k-generate-org-index]]: Read Emacs Lisp from current buffer and write org index to OUTPUT-BUFFER.
  ...
  - Function [[file:init.el#L3822][k-generate-org-index-init]]: Generate README.org from init.el.
  - Function [[file:init.el#L3848][k-generate-org-index--magit-post-stage-hook]]

* [[file:init.el#L3856][Finale]]
