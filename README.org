...
* [[file:init.el#L2558][Terminal (vterm)]]

** Package [[file:init.el#L2562][vterm]]
 Ad-hoc workaround: interaction with wide fringe/padding
  - Function [[file:init.el#L2580][vterm--get-margin-width]]
  - Package [[file:init.el#L2584][multi-vterm]]

* [[file:init.el#L2589][Web browsing]]

** Package [[file:init.el#L2599][eww]]
  - Function [[file:init.el#L2607][k-eww-after-render-hook]]: Update EWW buffer title and save `k-eww-history'.
  - Function [[file:init.el#L2618][k-eww-read-url]], [[file:init.el#L2622][eww-new-buffer]]
  - Package [[file:init.el#L2639][pdf-tools]]

* [[file:init.el#L2664][⭐ System utils]]
  - Function [[file:init.el#L2666][k-screenshot]]: Save a screenshot and copy its path.
  - Function [[file:init.el#L2678][k-get-volume]]: Get volume.
  - Function [[file:init.el#L2689][k-set-volume]]: Change volume.
  - Package [[file:init.el#L2703][sudo-edit]], [[file:init.el#L2710][system-packages]]

** Package [[file:init.el#L2713][insecure-lock]]
  - Function [[file:init.el#L2715][insecure-lock-hide]]
* [[file:init.el#L2723][Org]]

** Package [[file:init.el#L2725][org]]
  - Function [[file:init.el#L2732][check-latex-fragment]], [[file:init.el#L2763][k-org-mode-hook]]
  - Package [[file:init.el#L2771][org-contrib]], [[file:init.el#L2776][org-variable-pitch]], [[file:init.el#L2778][org-superstar]], [[file:init.el#L2790][poly-org]]
  - Function [[file:init.el#L2809][k-polymode-init-inner-hook]]
  - Package [[file:init.el#L2814][engrave-faces]]

* [[file:init.el#L2856][ERC]]

** Package [[file:init.el#L2858][erc]]
  - Function [[file:init.el#L2879][erc-insert-timestamp-right]]

* [[file:init.el#L2893][Email]]
  - Function [[file:init.el#L2910][insert-plist]], [[file:init.el#L2941][k-format-relative-date]]
  - Package [[file:init.el#L2958][message]]

** Package [[file:init.el#L2965][notmuch]]
  - Function [[file:init.el#L2988][notmuch-search-show-result]]: Insert RESULT at POS.
  - Function [[file:init.el#L3020][k-update-notmuch]]: Update email database asynchronously.
  - Package [[file:init.el#L3035][smtpmail]]

* [[file:init.el#L3044][Input Method]]

** Package [[file:init.el#L3046][pyim]]
  - Function [[file:init.el#L3051][k-pyim-probe]]
  - Package [[file:init.el#L3060][pyim-basedict]], [[file:init.el#L3062][pyim-greatdict]]

* [[file:init.el#L3067][⭐ Misc handy commands]]
  - Function [[file:init.el#L3071][lookup-word]]
  - Function [[file:init.el#L3079][demolish-package]]: Nuke everything under namespace SYMBOL.
 ...
 https://gist.github.com/jdtsmith/1fbcacfe677d74bbe510aec80ac0050c
  - Function [[file:init.el#L3097][k-reraise-error]]: Call function FUNC with ARGS and re-raise any error which occurs.
    Useful for debugging post-command hooks and filter functions, which
    normally have their errors suppressed.
  - Function [[file:init.el#L3105][toggle-debug-on-hidden-errors]]: Toggle hidden error debugging for function FUNC.
  - Function [[file:init.el#L3116][k-straight-freeze-versions]]: Run `straight-freeze-versions' asynchronously in Emacs subprocess.

* [[file:init.el#L3126][⭐ Status area]]
 ...
 A status area at the right bottom corner (using the right side of global echo area).  It is used for displaying battery, time, and vampire time zone.
  - Function [[file:init.el#L3134][k-time-status]]: Status function for current time.
  - Function [[file:init.el#L3138][k-battery-status]]: Status function for battery status.
  - Function [[file:init.el#L3161][k-status-update]]: Update status area.

* [[file:init.el#L3184][Vampire timezone]]
 How much sun-protection-free time left?
  - Function [[file:init.el#L3192][time-to-vampire-time]]
  - Function [[file:init.el#L3204][vampire-time-status]]: Status function for vampire time zone.

* [[file:init.el#L3223][telega.el]]
 A heavily modified telega.el to tweak its appearance to my liking.

** Package [[file:init.el#L3230][telega]]
  - Function [[file:init.el#L3238][k-telega-chatbuf-attach-sticker]]
  - Advice [[file:init.el#L3269][telega-chars-xheight]], [[file:init.el#L3274][telega-sticker--create-image]], [[file:init.el#L3283][telega--fmt-text-faces]], [[file:init.el#L3289][telega-ins--special]], [[file:init.el#L3296][telega-ins--message0]], [[file:init.el#L3303][telega-ins--date]]
  - Function [[file:init.el#L3306][k-telega-load-all-history]]: Load all history in current chat.
  - Package [[file:init.el#L3341][enwc]], [[file:init.el#L3346][proced]]

* [[file:init.el#L3359][Undo Tree]]
  - Package [[file:init.el#L3361][undo-tree]]

* [[file:init.el#L3375][⭐ Org index generation]]
  - Package [[file:init.el#L3377][toc-org]]
  ...
  - Function [[file:init.el#L3533][k-generate-org-index-init]]: Generate README.org from init.el.
  - Function [[file:init.el#L3559][k-generate-org-index--magit-post-stage-hook]]

* [[file:init.el#L3567][Finale]]
